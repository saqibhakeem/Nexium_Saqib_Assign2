      ...
      >
        ...
        <div className="hero-content text-neutral-content text-center flex flex-col items-center justify-center px-4 sm:px-8 md:px-16 lg:px-24 w-full">
          <div className="max-w-md w-full bg-opacity-80 rounded-lg p-6 sm:p-8 md:p-10 lg:p-12">
            ...
            <Button className=" bg-[#F0E7D8] font-bold text-[#020202] hover:bg-[#5BC0EB] hover:text-[#020202] border-[#33658A] w-full sm:w-auto py-2 px-6 text-base sm:text-lg rounded-md shadow-md transition-all duration-200 ease-in-out cursor-pointer">
              Get Started
            </Button>
          </div>
        </div>
